...
[
    {
        product.name: "Samsung - 65 Class S90C OLED Smart Tizen TV",
        price: 1,999.99,
        ...
        {
        product.name: "Roku - 65 Class Select Series 4K Smart RokuTV"
        price: 349.99
        ...
        {
        product.name: "Insignia™ - 55 Class F30 Series LED 4K UHD Smart Fire TV"
        price: 249.99
        ...
        {
        product.name: "Samsung - 85 Class CU7000 Crystal UHD 4K UHD Smart Tizen TV"
        price: 1,199.99
        ...
        {
        product.name: "TCL - 98 Class S5 S-Class LED 4K UHD HDR Smart TV with Google TV"
        price: 2,999.99
        ...
        {
        product.name: "LG - 86” Class UQ75 Series LED 4K UHD Smart webOS TV"
        price: 1,199.99
        ...
        {
        product.name: "Westinghouse - 50 4K UHD Smart Roku TV with HDR"
        price: 219.99
        ...
        {
        product.name: "Insignia™ - 43 Class N10 Series LED Full HD TV"
        price: 119.99
        ...
        {
        product.name: "LG - 34 IPS LED UltraWide FHD AMD FreeSync Monitor with HDR (HDMI, DisplayPort) - Black"
        price: 279.99
        ...
        {
        product.name: "LG - 24 IPS LED FHD FreeSync Monitor (HDMI, VGA) - Black"
        price: 89.99
        ...
        {
        product.name: "Samsung - 27 T350 Series IPS FHD, AMD FreeSync Monitor (VESA, HDMI, VGA) - Dark Blue Gray"
        price: 149.99
        ...
        {
        product.name: "Samsung - ViewFinity S5 34 Ultra-WQHD 100Hz AMD FreeSync Monitor with HDR10 (DisplayPort, HDMI) - Black"
        price: 299.99
        ...
        {
        product.name: "Samsung - 27 390C Series Curved FHD AMD FreeSync Monitor (DP, HDMI, VGA) - Black"
        price: 129.99
        ...
        {
        product.name: "HP - 31.5 LED Full HD FreeSync Monitor - Silver & Black"
        price: 199.99
        ...
        {
        product.name: "Acer - Nitro 23.8 IPS LED FHD FreeSync Gaming Monitor (HDMI 2.0, Display Port)"
        price: 129.99
        ...
        {
        product.name: "Samsung - 27” Odyssey FHD IPS 240Hz G-Sync Gaming Monitor - Black"
        price: 299.99
        ...
        {
        product.name: "Energizer - MAX 10,000mAh 15W USB-C Fast Universal Portable Battery Charger/Power Bank with LCD screen for Smartphones & Accessories - Black"
        price: 29.99
        ...
        {
        product.name: "Insignia™ - 8' USB-C to USB-C Charge-and-Sync Cable - Black"
        price: 9.99
        ...
        {
        product.name: "Belkin 11-in-1 USB C Hub with 4K HDMI, DP, VGA, 100W PD Docking Station for MacBook Pro, Air, and more - Gray"
        price: 119.99
        ...
        {
        product.name: "CORSAIR - K60 PRO TKL Wired Optical-Mechanical OPX Linear Switch Gaming Keyboard with per-key RGB Backlighting - Black"
        price: 99.99
        ...
        {
        product.name: "Logitech - G502 X PLUS LIGHTSPEED Wireless Gaming Mouse with HERO 25K Sensor - Black"
        price: 141.99
        ...
        {
        product.name: "Sony - PlayStation 5 - DualSense Wireless Controller - Midnight Black"
        price: 69.99
        ...
        {
        product.name: "Microsoft - Elite Series 2 Wireless Controller for Xbox One, Xbox Series X, and Xbox Series S - Black"
        price: 179.99
        ...
        {
        product.name: "Backbone One (USB-C) - Mobile Gaming Controller for Android Series - Black"
        price: 99.99
        ...
        {
        product.name: "Microsoft - Xbox Series S 1TB All-Digital Console (Disc-Free Gaming) - Black"
        price: 349.99
        ...
        {
        product.name: "Sony - PlayStation 5 Console"
        price: 499.99
        ...
        {
        product.name: "Microsoft - Xbox Series X 1TB Console - Black"
        price: 499.99
        ...
        {
        product.name: "Nintendo - Switch OLED Console - The Legend of Zelda: Tears of the Kingdom Edition - Green"
        price: 359.99
        ...
        {
        product.name: "ASUS ROG Ally 7 120Hz FHD 1080p Gaming Handheld - AMD Ryzen Z1 Extreme Processor - 512GB - White"
        price: 699.99
        ...
        {
        product.name: "Nintendo - Geek Squad Certified Refurbished Switch Lite 32GB Console - Blue"
        price: 179.99
        ...
        {
        product.name: "Sony - Geek Squad Certified Refurbished PlayStation 4 1TB Console - Black"
        price: 259.99
        description: "Geek Squad® Certified Refurbished products are thoroughly, painstakingly and lovingly tested, so you can be sure that your device will work right, right away."
        ...
        {
        product.name: "Logitech - G CLOUD Gaming Handheld Console - White"
        price: 299.99
